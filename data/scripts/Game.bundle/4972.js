...
var g = require("./10.js");
var C = function (e) {
  function ABGCAMCommand() {
    return e !== null && e.apply(this, arguments) || this;
  }
  n.__extends(ABGCAMCommand, e);
  Object.defineProperty(ABGCAMCommand.prototype, "cmdId", {
    get: function () {
      return l.ClientConstSF.S2C_CREATE_ARMY_ATTACK_MOVEMENT_ALLIANCE_BATTLE_GROUND;
    },
    set: function (e) {
  ...
  ABGCAMCommand.prototype.executeCommand = function (e, t) {
    var i;
    if (t && t.length > 1) {
      i = JSON.parse(t[1]);
    }
  ...
  return ABGCAMCommand;
}(g.CastleCommand);
exports.ABGCAMCommand = C;
