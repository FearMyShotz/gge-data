...
exports.___baseEventTypeDefinition = i.Record({
  eventId: i.Literal(1031),
  coal: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  food: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  glass: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  iron: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  oil: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
