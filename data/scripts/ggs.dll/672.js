...
exports.___baseEventTypeDefinition = i.Record({
  eventId: i.Literal(1026),
  deltaAmount: i.Number.withConstraint(function (e) {
    return e >= 0 && e <= 100;
  }),
  minutes: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  newAmount: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  playerId: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  sourceId: i.Number.withConstraint(function (e) {
    return e >= -1 && e <= 10000;
  })
}).And(i.Partial({}));
