...
var O = require("./280.js");
var E = require("./163.js");
var y = require("./276.js");
var b = require("./20.js");
var D = require("./95.js");
var I = require("./47.js");
var T = require("./59.js");
var v = require("./713.js");
var S = require("./8.js");
var A = require("./340.js");
var L = require("./281.js");
var P = require("./115.js");
var M = require("./471.js");
var R = require("./3869.js");
var V = require("./3870.js");
var x = require("./3871.js");
var w = require("./3872.js");
var B = require("./839.js");
var F = require("./554.js");
var N = require("./3873.js");
...
var G = function () {
  ...
  AttackDialogWaveHandler.prototype.init = function (e, t) {
    ...
    S.ButtonHelper.initButtons([this.waveOverview.mc_detailView.mc_waveList.btn_slider], A.ClickFeedBackHoverSliderButton, 1);
    ...
    if (!this.isInit) {
      ...
      this._detailSupportWaveInfo = new x.AttackDialogWaveHandlerSupportToolDetail(this.waveOverview.mc_detailView.mc_support);
      this._detailWaveInfo = new w.AttackDialogWaveHandlerWaveInfoDetail(this.waveOverview.mc_detailView.mc_wave);
      this._detailFinalWaveInfo = new V.AttackDialogWaveHandlerFinalYardWaveInfoDetail(this.waveOverview.mc_detailView.mc_final);
      this.isInit = true;
    }
    ...
    this.waveOverview.addEventListener(k.CLICK, this.bindFunction(this.onClick));
    this.attackCosts.addEventListener(k.MOUSE_OVER, this.bindFunction(this.onMouseOver));
    this.attackCosts.addEventListener(k.MOUSE_OUT, this.bindFunction(this.onMouseOut));
    if (h.CastleModel.tutorialData.isTutorialActive) {
      this.cbx_middle.deselected();
      this.controller.changeSelectionForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_POSITION_MIDDLE, this.cbx_middle.isSelected);
      this.cbx_right.deselected();
      this.controller.changeSelectionForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_POSITION_RIGHT, this.cbx_right.isSelected);
    }
  ...
  AttackDialogWaveHandler.prototype.onUpdateSavedAutofill = function () {
    if (this.controller.getIsWaveSelectedForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_ALL)) {
      this.cbx_all.selected();
    } else {
      this.cbx_all.deselected();
    }
    if (this.controller.getIsWaveSelectedForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_POSITION_LEFT)) {
      this.cbx_left.selected();
    } else {
      this.cbx_left.deselected();
    }
    if (this.controller.getIsWaveSelectedForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_POSITION_MIDDLE)) {
      this.cbx_middle.selected();
    } else {
      this.cbx_middle.deselected();
    }
    if (this.controller.getIsWaveSelectedForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_POSITION_RIGHT)) {
      this.cbx_right.selected();
    } else {
      this.cbx_right.deselected();
    }
  ...
  AttackDialogWaveHandler.prototype.initScrollList = function () {
    ...
    if (!this.waveInfoList) {
      this.waveInfoList = new L.DynamicSliderAccordionComponent(this.waveOverview.mc_list, e, this.waveOverview.mc_list.mc_items.mask);
  ...
  AttackDialogWaveHandler.prototype.fillWaveInfo = function () {
    if (this.controller.isWaveDetailView) {
      ...
      if (M.AttackDialogHelper.canUseSupportTools()) {
        var t = new (a.getDefinitionByName("AttackDialog_DetailViewItem_SupportWave"))();
        e.addChild(t);
        this._detailScrollItems.push(new R.AttackDialogDetailViewScrollItem(t, F.AttackDialogWaveHandlerSupportToolWaveInfoItemFoldOut.CONST_WAVE_NAME));
      }
      for (var i = 0; i < this.attackInfoVO.army.getWaveCount(); i++) {
        ...
        e.addChild(n);
        this._detailScrollItems.push(new R.AttackDialogDetailViewScrollItem(n, i));
      }
      var s = new (a.getDefinitionByName("AttackDialog_DetailViewItem_FinalWave"))();
      e.addChild(s);
      this._detailScrollItems.push(new R.AttackDialogDetailViewScrollItem(s, B.AttackDialogWaveHandlerFinalYardWaveInfoItemFoldOut.CONST_WAVE_NAME));
      new y.SimpleLayoutStrategyVertical().apply(this._detailScrollItems, new U());
      ...
      if (M.AttackDialogHelper.canUseSupportTools()) {
        this.waveInfoList.addItem(this.getSupportWaveItem(this.controller.getIsWaveSelectedForAutoFill(F.AttackDialogWaveHandlerSupportToolWaveInfoItemFoldOut.CONST_WAVE_NAME), c));
      }
      ...
      this.waveInfoList.addItem(this.getFinalWaveItem(this.controller.getIsWaveSelectedForAutoFill(B.AttackDialogWaveHandlerFinalYardWaveInfoItemFoldOut.CONST_WAVE_NAME), c));
  ...
  AttackDialogWaveHandler.prototype.recycleWaveList = function () {
    ...
    this.supportWaveItem = this.waveInfoList.items.find(function (e) {
      return e instanceof F.AttackDialogWaveHandlerSupportToolWaveInfoItemFoldOut;
    });
    this.finalWaveItem = this.waveInfoList.items.find(function (e) {
      return e instanceof B.AttackDialogWaveHandlerFinalYardWaveInfoItemFoldOut;
    });
    var t = this.waveItemPool;
    this.waveItemPool = [];
    this.waveInfoList.items.filter(function (e) {
      return e instanceof N.AttackDialogWaveHandlerWaveInfoItemFoldOut;
    }).forEach(function (t) {
  ...
  AttackDialogWaveHandler.prototype.getSupportWaveItem = function (e, t) {
    ...
    if (this.supportWaveItem) {
      ...
      i = new F.AttackDialogWaveHandlerSupportToolWaveInfoItemFoldOut(e, t);
    }
    return i;
  };
  AttackDialogWaveHandler.prototype.getWaveInfoItem = function (e, t, i, n) {
    ...
    if (this.waveItemPool.length > 0) {
      ...
      o = new N.AttackDialogWaveHandlerWaveInfoItemFoldOut(this.attackInfoVO.army.waves[t], t, this.controller.getIsWaveSelectedForAutoFill(t), n);
    }
    return o;
  };
  AttackDialogWaveHandler.prototype.getFinalWaveItem = function (e, t) {
    ...
    if (this.finalWaveItem) {
      ...
      i = new B.AttackDialogWaveHandlerFinalYardWaveInfoItemFoldOut(e, t);
    }
    return i;
  };
  ...
  AttackDialogWaveHandler.prototype.updateMaxUnitCount = function (e) {
    ...
    if (t) {
      e.itemsLeftWall_units.maxItems = s.CombatConst.getAmountSoldiers(0, this.attackInfoVO.targetOwnerLevel, C.CastleEffectsHelper.getUnitsOnTheFlankBonusForAreaType(t, this.attackInfoVO.targetArea, M.AttackDialogHelper.isLegendaryFight), 0);
      e.itemsMiddleWall_units.maxItems = s.CombatConst.getAmountSoldiers(1, this.attackInfoVO.targetOwnerLevel, 0, C.CastleEffectsHelper.getUnitsOnTheFrontBonusForAreaType(t, this.attackInfoVO.targetArea, M.AttackDialogHelper.isLegendaryFight));
      e.itemsRightWall_units.maxItems = s.CombatConst.getAmountSoldiers(2, this.attackInfoVO.targetOwnerLevel, C.CastleEffectsHelper.getUnitsOnTheFlankBonusForAreaType(t, this.attackInfoVO.targetArea, M.AttackDialogHelper.isLegendaryFight), 0);
    }
  ...
  AttackDialogWaveHandler.prototype.fillAttackCosts = function () {
    ...
    o.GoodgameTextFieldManager.getInstance().registerTextField(this.attackCosts.txt_loot, new r.LocalizedNumberVO(M.AttackDialogHelper.getTotalLoot()));
  ...
  AttackDialogWaveHandler.prototype.updateBonusIcons = function () {
    ...
    l.int(this.attackInfoVO.targetArea.mapID > 0 ? this.attackInfoVO.targetArea.mapID : this.attackInfoVO.targetArea.kingdomID);
    var i = this.attackInfoVO.kingstowerBonus;
    var n = i > 0 && t;
    var o = this.attackInfoVO.monumentBonus > 0 && c.CastleFameHelper.canEarnFame(this.attackInfoVO.targetArea, u.ClientConstCastle.ACTION_TYPE_ATTACK);
    var a = "";
    if (n) {
      a += r.Localize.text("kingstower_fightscreen_value_tooltip", [i]);
      a += "\n";
    }
    if (o) {
      ...
      a += r.Localize.text("monument_fightscreen_value_tooltip", [e]);
      a += "\n";
    }
    this.waveOverview.mc_bonus_left.toolTipText = a.trim();
    this.waveOverview.mc_bonus_left.visible = a.length > 0;
    ...
    if (S.ButtonHelper.isButtonEnabled(e.target)) {
      switch (e.target) {
        case this.waveOverview.cbx_all:
          ...
          this.controller.changeSelectionForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_ALL, this.cbx_all.isSelected);
          break;
        case this.waveOverview.cbx_left:
          this.cbx_left.toggleSelected();
          this.controller.changeSelectionForAutoFill(P.AttackDialogController.AUTOFILL_SELECTION_POSITION_LEFT, this.cbx_left.isSelected);
          break;
  ...
  AttackDialogWaveHandler.prototype.updateSelectAllCBX = function () {
    ...
    if (this.attackInfoVO.yardWaveContainer) {
      e++;
      if (this.controller.getIsWaveSelectedForAutoFill(B.AttackDialogWaveHandlerFinalYardWaveInfoItemFoldOut.CONST_WAVE_NAME)) {
        t++;
      }
    }
  ...
  AttackDialogWaveHandler.prototype.onDetailViewChanged = function () {
    this.updateDetailViewSelectedState();
    var e = this.controller.selectedDetailView == F.AttackDialogWaveHandlerSupportToolWaveInfoItemFoldOut.CONST_WAVE_NAME;
    var t = this.controller.selectedDetailView == B.AttackDialogWaveHandlerFinalYardWaveInfoItemFoldOut.CONST_WAVE_NAME;
  ...
  AttackDialogWaveHandler.prototype.destroy = function () {
    ...
    this.clearDetailItems();
    this.waveOverview.removeEventListener(k.CLICK, this.bindFunction(this.onClick));
    this.attackCosts.removeEventListener(k.MOUSE_OVER, this.bindFunction(this.onMouseOver));
    this.attackCosts.removeEventListener(k.MOUSE_OUT, this.bindFunction(this.onMouseOut));
    this.defaultWaveCount = 0;
...
exports.AttackDialogWaveHandler = G;
