...
var T = function () {
  ...
  AttackDialogHelper.getTotalLoot = function () {
    ...
    return t += t * (Math.floor(c.CastleModel.researchData.getResearchEffectValue(d.EffectTypeEnum.EFFECT_TYPE_LOOT_CAPACITY_BOOST).strength) / 100);
  };
