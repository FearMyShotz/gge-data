...
exports.___baseEventTypeDefinition = i.Record({
  ...
  succeeded: i.Number.withConstraint(function (e) {
    return e >= 0 && e <= 1;
  }),
  unitLost: i.Number.withConstraint(function (e) {
    return e >= 0;
  }),
  unitSent: i.Number.withConstraint(function (e) {
    return e >= 0;
  })
}).And(i.Partial({}));
