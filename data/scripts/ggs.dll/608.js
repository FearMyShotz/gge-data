...
module.exports = function trimStart(e, t, n) {
  ...
  return castSlice(i, function charsStartIndex(e, t) {
    for (var n = -1, i = e.length; ++n < i && baseIndexOf(t, e[n], 0) > -1;);
    return n;
  }(i, stringToArray(t))).join("");
};