...
var n = function () {
  ...
  CastleEffectsHelper.getTotalLordLootCapacityBonusForArea = function (e, t, i = false) {
    return r.int(CastleEffectsHelper.getAccumulatedEquipmentBonusByEffectTypeForArea(e, c.EffectTypeEnum.EFFECT_TYPE_LOOT_CAPACITY, t).strength) + r.int(i ? l.CastleModel.legendSkillData.getTotalValueOfLegendSkillEffect(u.CastleLegendSkillEffectsEnum.LOOT_CAPACITY_BONUS) : 0);
  };
  CastleEffectsHelper.getUnitsOnTheFlankBonusForAreaType = function (e, t, i = false) {
    var n = r.int(CastleEffectsHelper.getAccumulatedEquipmentBonusByEffectTypeForArea(e, c.EffectTypeEnum.EFFECT_TYPE_ATTACK_UNIT_AMOUNT_FLANK, t.areaType).strength);
    var a = r.int(i ? l.CastleModel.legendSkillData.getTotalValueOfLegendSkillEffect(u.CastleLegendSkillEffectsEnum.ADDITIONAL_UNIT_AMOUNT_ON_FLANK) : 0);
    var s = r.int(o.CastleTitleSystemHelper.returnTitleEffectValue(c.EffectTypeEnum.EFFECT_TYPE_ATTACK_UNIT_AMOUNT_FLANK, -1, t.areaType, t.spaceID).strength);
    var d = 0;
    if (l.CastleModel.allianceData.myAllianceVO) {
      d = r.int(l.CastleModel.allianceData.myAllianceVO.getLayoutEffectStrengthByType(c.EffectTypeEnum.EFFECT_TYPE_ATTACK_UNIT_AMOUNT_FLANK));
    }
    return n + a + s + d;
  };
  CastleEffectsHelper.getUnitsOnTheFrontBonusForAreaType = function (e, t, i = false) {
    var n = r.int(CastleEffectsHelper.getAccumulatedEquipmentBonusByEffectTypeForArea(e, c.EffectTypeEnum.EFFECT_TYPE_ATTACK_UNIT_AMOUNT_FRONT, t.areaType).strength);
    var a = r.int(i ? l.CastleModel.legendSkillData.getTotalValueOfLegendSkillEffect(u.CastleLegendSkillEffectsEnum.ADDITIONAL_UNIT_AMOUNT_ON_FRONT) : 0);
    var s = r.int(o.CastleTitleSystemHelper.returnTitleEffectValue(c.EffectTypeEnum.EFFECT_TYPE_ATTACK_UNIT_AMOUNT_FRONT, -1, t.areaType, t.spaceID).strength);
    var d = 0;
    if (l.CastleModel.allianceData.myAllianceVO) {
      d = r.int(l.CastleModel.allianceData.myAllianceVO.getLayoutEffectStrengthByType(c.EffectTypeEnum.EFFECT_TYPE_ATTACK_UNIT_AMOUNT_FRONT));
    }
    return n + a + s + d;
  };
